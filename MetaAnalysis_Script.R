...
## Artificial Nest Provision - no captive - Table S11
...
meta_interactive_nest_1 <- rma.mv(yi, vi, random=list(~1|effect_size_id,~1|Study.Name,~1|BirdTree.Tip,~1|phylo), R = list(phylo = bird_phylo_cor), mods = ~factor(Nestboxes.Burrows.Sites)*relevel(factor(Threat_Status_SUB),ref="Non-threatened"), test="t", method="REML", data=ies.da)
